...
\begin{proof}
\input{proofJLemmaSelfAdjointnessAndSpectralBoundedness}
\end{proof}
\end{lemma}
...
\begin{proof}
\input{proofJLemmaReflectionPositivity}
\end{proof}
\end{lemma}
...
\begin{proof}
\input{proofJLemmaSpatialMetricPositivity}
\end{proof}
\end{lemma}
...
\begin{proof}
\input{proofJLemmaLapseStrictPositive}
\end{proof}
\end{lemma}
...
\begin{proof}
\input{proofJLemmaUniqueNegativeEigenvalue}
\end{proof}
\end{lemma}
...
\input{proofJLemmaLorentzianSignatureSignControlExplicit}

\input{proofJLemmaStableLorentzianSignature}
...
\begin{proof}
\input{proofJTheoremLapsePositivity}
\end{proof}
\end{theorem}
