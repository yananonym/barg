...
The key insight is that the coercivity of the Hessian $D^2\Phi$ (Axiom II, component II.ii: $\inf_u \langle D^2\Phi u, u \rangle / \|u\|^2 =: \lambda_0 > 0$) is a topological property—it depends only on whether the Hessian is positive-definite, not on its specific eigenvalue magnitudes. The RG flow preserves this positivity.
