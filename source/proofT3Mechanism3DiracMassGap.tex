...
The key insight is that zero modes of the Dirac operator create excitations with energy approaching zero (in the UV limit). If such zero modes are to become abundant (multiply without bound), the spectrum would extend down to zero energy, closing the mass gap.
