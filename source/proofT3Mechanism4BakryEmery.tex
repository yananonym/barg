...
More precisely, by the Chern-Weyl construction and the theory of KÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hler geometry on the space of probability measures, a metric defined by the Hessian of a convex function has $\mathrm{Ric} \geq 0$.
...
If Mechanisms M1', M2', or M3' also hold, their predicted gap scales must be consistent with the Bakry-Émery bound $\Delta_{\text{YM}} \geq (4/3) \beta \lambda_0$ from Mechanism M4'. The concordance of all four mechanisms suggests that the mass gap is a highly constrained property of the divergence-first framework.
