...
\input{proofDDefinitionPrimitiveSpectralStructure}

\input{proofDLemmaCheegerDifferentiability}
...
\begin{proof}
\input{proofDLemmaCheegerSpectralGap}
\end{proof}
\end{lemma}
